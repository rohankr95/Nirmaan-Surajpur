                    ...
                    <div class="panel-body p-0">
                        <table class="table table-bordered table-hover table-striped table-sm m-0">
                            ...
                            @foreach($villages as $list)
                                <tr>
                                    <td>{{ $sl++ }}</td>
                                    <td>{{ $list->grampanchayat_name }}</td>
                                    <td>{{ $list->block->block_name }}</td>
                                    <td>{{ $list->block->subdivision->subdivision_name }}</td>
                                    <td>{{ $list->block->subdivision->district->district_name }}</td>
                                    <td>{{ $list->block->subdivision->district->state->state_name }}</td>
                                    <td>
